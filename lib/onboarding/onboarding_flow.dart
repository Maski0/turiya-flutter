...
class _OnboardingFlowState extends State<OnboardingFlow> {
  ...
  void _previousStep() {
    if (currentStep > 0) {
      setState(() {
        currentStep--;
        // Skip acknowledgement screens (auto-advance screens without back button)
        // Case 2: Greeting, Case 4/6/8: Interludes, Case 9: Stats
        while (currentStep > 0 && _isAcknowledgementScreen(currentStep)) {
          currentStep--;
        }
      });
    }
  ...
  bool _isAcknowledgementScreen(int step) {
    return step == 2 || step == 4 || step == 6 || step == 8 || step == 9;
  }
