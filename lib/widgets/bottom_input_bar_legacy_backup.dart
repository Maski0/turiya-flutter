...
/// Backup snapshot of the original bottom input bar widget, kept so we can
/// compare behavior while restyling `BottomInputBar` to the new design.
class LegacyBottomInputBar extends StatefulWidget {
  ...
  @override
  State<LegacyBottomInputBar> createState() => _LegacyBottomInputBarState();
}

class _LegacyBottomInputBarState extends State<LegacyBottomInputBar> {
  @override
  void initState() {
    super.initState();
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        else if (widget.isAudioPlaying && widget.onStopAudio != null)
