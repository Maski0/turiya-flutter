...
class _BottomInputBarState extends State<BottomInputBar> with TickerProviderStateMixin {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (glowIntensity > 0) {
      ...
      final pulseGlowPaint = Paint()
        ...
        ..maskFilter = MaskFilter.blur(BlurStyle.normal, 8 + (8 * glowIntensity)); // Pulse blur from 8 to 16
      ...
      final centerGlowPaint = Paint()
        ..shader = RadialGradient(
          ...
          radius: 0.8,
          colors: [
            Colors.white.withOpacity(0.6 * glowIntensity), // Bright white center
        ...
        ..maskFilter = MaskFilter.blur(BlurStyle.normal, 12 + (12 * glowIntensity));
